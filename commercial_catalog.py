...
def build_commercial_ai_context():
    return (
        ...
        "Para mantener la comunidad publicada después de la prueba, el creador debe activar una suscripción del servicio. "
        "Si será de pago, debe configurarse Stripe o el método de cobro antes de vender accesos. "
        "Puede usarse Stripe propio del dueño o Stripe de la plataforma.\n"
        "Los planes comerciales previstos para el espacio compartido son 1 mes, 6 meses y 1 año. "
        "Si un plan no tiene precio o stripe_price_id, debe decirse que está pendiente de configurar por un administrador.\n"
