...
def build_owner_location_management_text(group_id):
    ...
    return (
        ...
        "Esto sirve para pedir al usuario una ubicación real de Telegram antes de generar el link de acceso. "
...
def build_owner_security_text(group_id):
    ...
    return (
        ...
        f"Comunidad: {group_name or f'Grupo {group_id}'}\n\n"
        "Estado actual:\n"
        "- Anti-intrusos: activo con validación de users/invite_links.\n"
        "- Links no registrados: se bloquean desde el control de entrada.\n"
        f"- Restricción por ubicación: {location_status}.\n"
        f"- Región permitida: {region_label}.\n\n"
        "Opciones útiles:\n"
        "- Revisa logs de accesos para ver entradas permitidas o bloqueadas.\n"
        "- Gestiona ubicación permitida si quieres filtrar por país o comunidad autónoma.\n"
        "- Usa Usuarios y accesos para expulsiones, bans y warnings."
    )
...
def build_owner_security_keyboard(group_id):
    ...
    return InlineKeyboardMarkup([
        ...
        [InlineKeyboardButton("📜 Logs de accesos", callback_data="admin_logs_security")],
        [InlineKeyboardButton("👥 Usuarios y accesos", callback_data="owner_panel_users")],
...
def build_owner_panel_help_text(section):
    ...
    help_texts = {
        ...
        "logs": "📜 Logs y actividad\n\nRevisa actividad importante: accesos, pagos, códigos, backups y errores.",
...
def build_owner_panel_audit_report(user_id, group_id):
    ...
    for button in all_buttons:
        ...
        if callback_data in placeholder_callbacks:
            ...
            placeholders += 1
            observations.append("acción informativa pendiente de flujo completo")
...
def format_owner_panel_audit_summary(report):
    ...
    return (
        ...
        f"Acciones informativas pendientes: {report.get('placeholders')}\n\n"
